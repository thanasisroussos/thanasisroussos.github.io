...
document.getElementById("toHome").addEventListener('click', () => {
  scrollTo(document.getElementById("home"));closeMenu();
});

document.getElementById("toAbout").addEventListener('click', () => {
  scrollTo(document.getElementById("about"));closeMenu();
});

document.getElementById("toWork").addEventListener('click', () => {
  scrollTo(document.getElementById("work"));closeMenu();
});


document.getElementById("toFooter").addEventListener('click', () => {
  scrollTo(document.getElementById("footer"));closeMenu();
});
