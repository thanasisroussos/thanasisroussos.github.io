...
var text_developer_00 = "I am a ";
var text_Developer1 = "Web Developer";
var text_Developer2 = "Front-End Developer";
var text_Developer3 = "UI/UX Developer";
var text_Developer4 = "Creative Developer";
function end_loading(){
	/*$('#loading').delay(1000).fadeOut(300)*/;
	TweenLite.to("#loading", 1,{autoAlpha:0, delay:3, onComplete:end_loading_two});
...
function codeAddress() {
    TweenLite.to(".text00", 1,{alpha:1, ease:Bounce.easeOut});
	TweenLite.to(".text01", 1,{alpha:1, ease:Bounce.easeOut, delay:1});
	TweenLite.delayedCall(.5,text_dev0);
	
}
function text_dev0(){TweenLite.to(("#text_Developer_first"), 1.5, {text:text_developer_00, ease:Linear.easeNone, delay:1,onComplete:text_dev01});	}
function text_dev01(){TweenLite.to(("#text_Developer_00"), 1.5, {text:text_Developer1, ease:Linear.easeNone, onComplete:text_dev2});	}



function text_dev1(){TweenLite.to(("#text_Developer_00"), 1.5, {text:text_Developer1, ease:Linear.easeNone,delay:2, onComplete:text_dev2});	}
function text_dev2(){TweenLite.to(("#text_Developer_00"), 1.5, {text:text_Developer2, ease:Linear.easeNone, delay:2,onComplete:text_dev3});	}
function text_dev3(){TweenLite.to(("#text_Developer_00"), 1.5, {text:text_Developer3, ease:Linear.easeNone, delay:2,onComplete:text_dev4});	}
function text_dev4(){TweenLite.to(("#text_Developer_00"), 1.5, {text:text_Developer4, ease:Linear.easeNone, delay:2,onComplete:text_dev1});	}
...
function start_arrow(){
	TweenMax.to(".fa-angle-down", .1, {delay:3, alpha:0, onComplete: start_Arrow2});
}
function start_Arrow2(){
	TweenMax.to(".fa-angle-down", .1, {y:-20, onComplete: start_Arrow3});
}
function start_Arrow3(){
	TweenMax.to(".fa-angle-down", .5, {y:0, alpha:1, onComplete: start_arrow});
}
	function start(){
